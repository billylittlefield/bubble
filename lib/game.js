(function() {
  ...
  Game.prototype.drawLevel = function (ctx) {
    ...
    ctx.fillText("Level" + this.level, 300, 430);
  };
  ...
  Game.prototype.drawDeadScreen = function () {
    ...
    if (this.dead) {
      ...
      ctx.fillStyle = "white";
      ctx.textAlign = "center";
      ctx.fillText("THE   DRAGON   WAS", 300, 200);
      ctx.fillText("CRUSHED    BY    BUBBLES!", 310, 250);
      ctx.fillText(this.lives + "   EXTRA   " + lives + "   LEFT", 310, 300);
    }
  };
  ...
  Game.prototype.drawNextLevelScreen = function () {
    if (this.nextLevel) {
      ...
      ctx.fillStyle = "white";
      ctx.textAlign = "center";
      ctx.fillText("YOU   BURNED   YOUR    WAY", 300, 200);
      ctx.fillText("THROUGH    LEVEL   " + (this.level - 1), 310, 250);
      if (this.lives < 5) {
        ctx.fillText("HAVE   AN   EXTRA    LIFE", 310, 300);
      }
    }
  };
