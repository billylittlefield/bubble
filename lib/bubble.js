(function() {
  ...
  Bubble.BALL_COLOR = ["", "images/gold_ball.png",  "images/blue_ball.png",
                           "images/green_ball.png", "images/orange_ball.png",
                           "images/pink_ball.png"];
  Bubble.AUDIO_FILE = ["", "sounds/highest-pop.mp3", "sounds/high-pop.mp3",
                           "sounds/middle-pop.mp3", "sounds/low-pop.mp3",
                           "sounds/lowest-pop.mp3"];
  ...
  Bubble.prototype.collideWith = function (object) {
    if (object instanceof BubbleGame.Dragon) {
      ...
      setTimeout(function() { this.pop(); }.bind(this), 0);
  ...
  Bubble.prototype.pop = function (combo) {
    this.sound.volume = this.game.soundEffects ? 0.4 : 0;
    this.sound.play();
    this.game.score += 10;
    if (combo === "combo") {
      this.game.score += 50;
